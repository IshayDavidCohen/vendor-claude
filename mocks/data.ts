...
let items: Item[] = [
  // Wine items
  { id: 'item-wine-1', supplier_id: 'sup-premium-wines', name: 'Château Margaux 2018', category: 'cat-alcohol', image: 'https://images.unsplash.com/photo-1553361371-9b22f78e8b1d?w=400', desc: 'Premier Grand Cru Classé from Bordeaux. Rich and elegant with notes of blackcurrant and cedar.', base_price: 450.00, unit: 'bottle', currency: 'USD', custom_prices: { 'bus-demo': 420.00 }, stock_quantity: 24, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-wine-2', supplier_id: 'sup-premium-wines', name: 'Opus One 2019', category: 'cat-alcohol', image: 'https://images.unsplash.com/photo-1586370434639-0fe43b2d32d6?w=400', desc: 'Napa Valley red blend. Silky tannins with layers of dark fruit and spice.', base_price: 380.00, unit: 'bottle', currency: 'USD', custom_prices: {}, stock_quantity: 18, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-wine-3', supplier_id: 'sup-premium-wines', name: 'Dom Pérignon 2012', category: 'cat-alcohol', image: 'https://images.unsplash.com/photo-1594372365401-3bc16c4c7d1b?w=400', desc: 'Prestige cuvée champagne. Exceptional vintage with fine bubbles and toasty notes.', base_price: 220.00, unit: 'bottle', currency: 'USD', custom_prices: { 'bus-demo': 195.00 }, stock_quantity: 36, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-wine-4', supplier_id: 'sup-premium-wines', name: 'Cloudy Bay Sauvignon Blanc', category: 'cat-alcohol', image: 'https://images.unsplash.com/photo-1566754436893-1c49778ab51e?w=400', desc: 'New Zealand white wine. Crisp and refreshing with citrus and tropical notes.', base_price: 28.00, unit: 'bottle', currency: 'USD', custom_prices: {}, stock_quantity: 120, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-wine-5', supplier_id: 'sup-premium-wines', name: 'Penfolds Grange 2017', category: 'cat-alcohol', image: 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=400', desc: 'Australian Shiraz. Bold and powerful with dark chocolate and plum flavors.', base_price: 850.00, unit: 'bottle', currency: 'USD', custom_prices: {}, stock_quantity: 6, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },

  // Spirits items
  { id: 'item-spirit-1', supplier_id: 'sup-craft-spirits', name: 'Small Batch Bourbon', category: 'cat-alcohol', image: 'https://images.unsplash.com/photo-1527281400683-1aae777175f8?w=400', desc: 'Hand-crafted bourbon aged 8 years. Caramel, vanilla, and oak notes.', base_price: 65.00, unit: 'bottle', currency: 'USD', custom_prices: {}, stock_quantity: 45, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-spirit-2', supplier_id: 'sup-craft-spirits', name: 'London Dry Gin', category: 'cat-alcohol', image: 'https://images.unsplash.com/photo-1608885898957-a559228e8749?w=400', desc: 'Botanical gin with juniper, citrus, and floral notes. Perfect for cocktails.', base_price: 45.00, unit: 'bottle', currency: 'USD', custom_prices: {}, stock_quantity: 60, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-spirit-3', supplier_id: 'sup-craft-spirits', name: 'Premium Vodka', category: 'cat-alcohol', image: 'https://images.unsplash.com/photo-1613752966027-6e30f7faa643?w=400', desc: 'Triple-distilled premium vodka. Smooth and clean finish.', base_price: 38.00, unit: 'bottle', currency: 'USD', custom_prices: {}, stock_quantity: 0, out_of_stock: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },

  // Beer items
  { id: 'item-beer-1', supplier_id: 'sup-beer-masters', name: 'Craft IPA 6-Pack', category: 'cat-alcohol', image: 'https://images.unsplash.com/photo-1566633806327-68e152aaf26d?w=400', desc: 'West Coast style IPA with citrus hops. 6.5% ABV.', base_price: 14.00, unit: '6-pack', currency: 'USD', custom_prices: { 'bus-demo': 12.50 }, stock_quantity: 200, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-beer-2', supplier_id: 'sup-beer-masters', name: 'Belgian Wheat Ale Case', category: 'cat-alcohol', image: 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=400', desc: 'Traditional Belgian witbier with orange peel and coriander. Case of 24.', base_price: 48.00, unit: 'case', currency: 'USD', custom_prices: {}, stock_quantity: 80, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-beer-3', supplier_id: 'sup-beer-masters', name: 'Stout 4-Pack', category: 'cat-alcohol', image: 'https://images.unsplash.com/photo-1608270586620-248524dae6a55?w=400', desc: 'Rich imperial stout with coffee and chocolate notes. 8.2% ABV.', base_price: 16.00, unit: '4-pack', currency: 'USD', custom_prices: {}, stock_quantity: 48, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-beer-4', supplier_id: 'sup-beer-masters', name: 'Pilsner Keg', category: 'cat-alcohol', image: 'https://images.unsplash.com/photo-1618183479302-1e0aa382c36b?w=400', desc: 'Classic Czech-style pilsner. 5L mini keg for events.', base_price: 45.00, unit: 'keg', currency: 'USD', custom_prices: {}, stock_quantity: 8, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },

  // Meat items
  { id: 'item-meat-1', supplier_id: 'sup-prime-meats', name: 'USDA Prime Ribeye', category: 'cat-meat', image: 'https://images.unsplash.com/photo-1615937691194-97dbd3f3dc29?w=400', desc: '28-day dry-aged prime ribeye. Exceptional marbling.', base_price: 52.00, unit: 'lb', currency: 'USD', custom_prices: { 'bus-demo': 48.00 }, stock_quantity: 150, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-meat-2', supplier_id: 'sup-prime-meats', name: 'Wagyu Tenderloin A5', category: 'cat-meat', image: 'https://images.unsplash.com/photo-1603048297172-c92544798d5a?w=400', desc: 'Japanese A5 Wagyu tenderloin. Ultimate in beef quality.', base_price: 180.00, unit: 'lb', currency: 'USD', custom_prices: {}, stock_quantity: 20, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-meat-3', supplier_id: 'sup-prime-meats', name: 'Lamb Rack Frenched', category: 'cat-meat', image: 'https://images.unsplash.com/photo-1603360946369-dc9bb6258143?w=400', desc: 'New Zealand lamb rack, frenched and trimmed.', base_price: 38.00, unit: 'rack', currency: 'USD', custom_prices: {}, stock_quantity: 30, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-meat-4', supplier_id: 'sup-prime-meats', name: 'Kurobuta Pork Chops', category: 'cat-meat', image: 'https://images.unsplash.com/photo-1432139555190-58524dae6a55?w=400', desc: 'Heritage Berkshire pork chops, double-cut.', base_price: 24.00, unit: 'lb', currency: 'USD', custom_prices: {}, stock_quantity: 75, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-meat-5', supplier_id: 'sup-prime-meats', name: 'Veal Osso Buco', category: 'cat-meat', image: 'https://images.unsplash.com/photo-1588347818036-558601350947?w=400', desc: 'Premium veal shank cuts for osso buco.', base_price: 28.00, unit: 'lb', currency: 'USD', custom_prices: {}, stock_quantity: 40, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-meat-6', supplier_id: 'sup-prime-meats', name: 'Duck Breast Magret', category: 'cat-meat', image: 'https://images.unsplash.com/photo-1518492104633-130d0cc84637?w=400', desc: 'Moulard duck breast, skin-on.', base_price: 22.00, unit: 'piece', currency: 'USD', custom_prices: {}, stock_quantity: 25, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },

  // Organic items
  { id: 'item-organic-1', supplier_id: 'sup-organic-farms', name: 'Free-Range Chicken', category: 'cat-meat', image: 'https://images.unsplash.com/photo-1587593810167-a84920ea0781?w=400', desc: 'Pasture-raised whole chicken, 4-5 lbs.', base_price: 18.00, unit: 'each', currency: 'USD', custom_prices: {}, stock_quantity: 35, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-organic-2', supplier_id: 'sup-organic-farms', name: 'Organic Eggs', category: 'cat-dairy', image: 'https://images.unsplash.com/photo-1582722872445-44dc5f7e3c8f?w=400', desc: 'Farm-fresh organic eggs, dozen.', base_price: 8.00, unit: 'dozen', currency: 'USD', custom_prices: {}, stock_quantity: 100, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-organic-3', supplier_id: 'sup-organic-farms', name: 'Heirloom Tomatoes', category: 'cat-produce', image: 'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=400', desc: 'Mixed heirloom tomatoes, vine-ripened.', base_price: 6.00, unit: 'lb', currency: 'USD', custom_prices: {}, stock_quantity: 60, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-organic-4', supplier_id: 'sup-organic-farms', name: 'Mixed Microgreens', category: 'cat-produce', image: 'https://images.unsplash.com/photo-1622206151226-18ca2c9ab4a1?w=400', desc: 'Organic microgreen mix, chef selection.', base_price: 12.00, unit: 'lb', currency: 'USD', custom_prices: {}, stock_quantity: 15, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },

  // Dairy items
  { id: 'item-dairy-1', supplier_id: 'sup-dairy-direct', name: 'Whole Milk', category: 'cat-dairy', image: 'https://images.unsplash.com/photo-1563636619-e9143da7973b?w=400', desc: 'Fresh whole milk from grass-fed cows.', base_price: 5.50, unit: 'gallon', currency: 'USD', custom_prices: { 'bus-demo': 5.00 }, stock_quantity: 200, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-dairy-2', supplier_id: 'sup-dairy-direct', name: 'Heavy Cream', category: 'cat-dairy', image: 'https://images.unsplash.com/photo-1559598467-f8b76c8155d0?w=400', desc: '40% butterfat heavy whipping cream.', base_price: 8.00, unit: 'quart', currency: 'USD', custom_prices: {}, stock_quantity: 80, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-dairy-3', supplier_id: 'sup-dairy-direct', name: 'Cultured Butter', category: 'cat-dairy', image: 'https://images.unsplash.com/photo-1589985270826-4b7bb135bc9d?w=400', desc: 'European-style cultured butter.', base_price: 12.00, unit: 'lb', currency: 'USD', custom_prices: {}, stock_quantity: 50, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-dairy-4', supplier_id: 'sup-dairy-direct', name: 'Greek Yogurt', category: 'cat-dairy', image: 'https://images.unsplash.com/photo-1571212515416-fef01fc43637?w=400', desc: 'Thick, creamy Greek-style yogurt.', base_price: 6.00, unit: 'quart', currency: 'USD', custom_prices: {}, stock_quantity: 90, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-dairy-5', supplier_id: 'sup-dairy-direct', name: 'Crème Fraîche', category: 'cat-dairy', image: 'https://images.unsplash.com/photo-1625937286074-9ca519d5d9df?w=400', desc: 'French-style cultured cream.', base_price: 9.00, unit: 'pint', currency: 'USD', custom_prices: {}, stock_quantity: 40, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },

  // Cheese items
  { id: 'item-cheese-1', supplier_id: 'sup-artisan-cheese', name: 'Aged Gruyère', category: 'cat-dairy', image: 'https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?w=400', desc: 'Swiss Gruyère aged 18 months.', base_price: 24.00, unit: 'lb', currency: 'USD', custom_prices: {}, stock_quantity: 30, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-cheese-2', supplier_id: 'sup-artisan-cheese', name: 'Parmigiano Reggiano', category: 'cat-dairy', image: 'https://images.unsplash.com/photo-1552767059-ce182ead6c1b?w=400', desc: '24-month aged Italian parmesan, DOP certified.', base_price: 28.00, unit: 'lb', currency: 'USD', custom_prices: {}, stock_quantity: 25, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-cheese-3', supplier_id: 'sup-artisan-cheese', name: 'Burrata', category: 'cat-dairy', image: 'https://images.unsplash.com/photo-1626957341926-98752fc2ba90?w=400', desc: 'Fresh Italian burrata, cream-filled.', base_price: 14.00, unit: 'piece', currency: 'USD', custom_prices: {}, stock_quantity: 0, out_of_stock: true, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-cheese-4', supplier_id: 'sup-artisan-cheese', name: 'Manchego Reserva', category: 'cat-dairy', image: 'https://images.unsplash.com/photo-1634487359989-3e90c9432133?w=400', desc: 'Spanish sheep milk cheese, aged 12 months.', base_price: 22.00, unit: 'lb', currency: 'USD', custom_prices: {}, stock_quantity: 18, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },

  // Seafood items
  { id: 'item-seafood-1', supplier_id: 'sup-ocean-harvest', name: 'Wild Salmon Fillet', category: 'cat-seafood', image: 'https://images.unsplash.com/photo-1485921325833-c519f76c4927?w=400', desc: 'Wild-caught Alaskan king salmon, skin-on fillet.', base_price: 32.00, unit: 'lb', currency: 'USD', custom_prices: { 'bus-demo': 29.00 }, stock_quantity: 60, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-seafood-2', supplier_id: 'sup-ocean-harvest', name: 'Jumbo Prawns', category: 'cat-seafood', image: 'https://images.unsplash.com/photo-1565680018434-b513d5e5fd47?w=400', desc: 'U10 tiger prawns, head-on.', base_price: 28.00, unit: 'lb', currency: 'USD', custom_prices: {}, stock_quantity: 45, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-seafood-3', supplier_id: 'sup-ocean-harvest', name: 'Live Maine Lobster', category: 'cat-seafood', image: 'https://images.unsplash.com/photo-1559737558-2f5a35f4523b?w=400', desc: 'Live Maine lobster, 1.5-2 lbs.', base_price: 45.00, unit: 'each', currency: 'USD', custom_prices: {}, stock_quantity: 12, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-seafood-4', supplier_id: 'sup-ocean-harvest', name: 'Sashimi-Grade Tuna', category: 'cat-seafood', image: 'https://images.unsplash.com/photo-1534604973900-c43ab4c2e0ab?w=400', desc: 'Bluefin tuna loin, sashimi quality.', base_price: 55.00, unit: 'lb', currency: 'USD', custom_prices: {}, stock_quantity: 20, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-seafood-5', supplier_id: 'sup-ocean-harvest', name: 'Fresh Oysters', category: 'cat-seafood', image: 'https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?w=400', desc: 'Kumamoto oysters, live, per dozen.', base_price: 24.00, unit: 'dozen', currency: 'USD', custom_prices: {}, stock_quantity: 72, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },

  // Produce items
  { id: 'item-produce-1', supplier_id: 'sup-green-valley', name: 'Baby Arugula', category: 'cat-produce', image: 'https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=400', desc: 'Fresh baby arugula, pre-washed.', base_price: 4.00, unit: 'lb', currency: 'USD', custom_prices: { 'bus-demo': 3.50 }, stock_quantity: 100, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-produce-2', supplier_id: 'sup-green-valley', name: 'Mixed Bell Peppers', category: 'cat-produce', image: 'https://images.unsplash.com/photo-1563565375-f3fdfdbefa83?w=400', desc: 'Red, yellow, and orange bell peppers.', base_price: 5.00, unit: 'lb', currency: 'USD', custom_prices: {}, stock_quantity: 80, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-produce-3', supplier_id: 'sup-green-valley', name: 'Fresh Herbs Bundle', category: 'cat-produce', image: 'https://images.unsplash.com/photo-1466637574441-749b8f19452f?w=400', desc: 'Chef selection of fresh herbs.', base_price: 8.00, unit: 'bundle', currency: 'USD', custom_prices: {}, stock_quantity: 40, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-produce-4', supplier_id: 'sup-green-valley', name: 'Meyer Lemons', category: 'cat-produce', image: 'https://images.unsplash.com/photo-1590502593747-42a996133562?w=400', desc: 'Sweet Meyer lemons, organic.', base_price: 4.50, unit: 'lb', currency: 'USD', custom_prices: {}, stock_quantity: 55, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-produce-5', supplier_id: 'sup-green-valley', name: 'Baby Spinach', category: 'cat-produce', image: 'https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=400', desc: 'Tender baby spinach leaves.', base_price: 5.00, unit: 'lb', currency: 'USD', custom_prices: {}, stock_quantity: 90, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-produce-6', supplier_id: 'sup-green-valley', name: 'Wild Mushroom Mix', category: 'cat-produce', image: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400', desc: 'Chanterelle, shiitake, and oyster mushrooms.', base_price: 18.00, unit: 'lb', currency: 'USD', custom_prices: {}, stock_quantity: 5, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },

  // Bakery items
  { id: 'item-bakery-1', supplier_id: 'sup-artisan-bakery', name: 'Sourdough Boule', category: 'cat-bakery', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=400', desc: 'Traditional sourdough with crispy crust.', base_price: 8.00, unit: 'loaf', currency: 'USD', custom_prices: {}, stock_quantity: 30, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-bakery-2', supplier_id: 'sup-artisan-bakery', name: 'French Baguette', category: 'cat-bakery', image: 'https://images.unsplash.com/photo-1549931319-a545dcf3bc73?w=400', desc: 'Classic French baguette, baked fresh.', base_price: 4.00, unit: 'piece', currency: 'USD', custom_prices: {}, stock_quantity: 50, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-bakery-3', supplier_id: 'sup-artisan-bakery', name: 'Butter Croissants', category: 'cat-bakery', image: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=400', desc: 'Flaky, all-butter croissants, box of 12.', base_price: 36.00, unit: 'box', currency: 'USD', custom_prices: {}, stock_quantity: 20, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
  { id: 'item-bakery-4', supplier_id: 'sup-artisan-bakery', name: 'Ciabatta Rolls', category: 'cat-bakery', image: 'https://images.unsplash.com/photo-1586444248879-bc604cbcc439?w=400', desc: 'Italian ciabatta rolls, dozen.', base_price: 12.00, unit: 'dozen', currency: 'USD', custom_prices: {}, stock_quantity: 36, out_of_stock: false, created_at: '2024-01-01T00:00:00Z', updated_at: '2024-01-01T00:00:00Z' },
];
